...
// コンストラクタ
CHeavyWarrior::CHeavyWarrior(CPlayer* player, int level)
...
void CHeavyWarrior::ShotNeedle()
{
	...
	for (int i = 0; i < ATTACK2_NEEDLE_SHOT_DIR_COUNT; i++)
	{
		...
		//CHeavyWarriorNeedle* needle = new CHeavyWarriorNeedle(ATTACK2_NEEDLE_SPEED, ATTACK2_NEEDLE_DIST);
		//needle->Position(pos);
