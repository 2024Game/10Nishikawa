...
#define ATTACK2_PROB 90				// 針攻撃を行う確率（パーセント）
...
#define ATTACK2_NEEDLE_SPEED 150.0f	// 針の速度
#define ATTACK2_NEEDLE_DIST 250.0f	// 針が移動できる距離
#define ATTACK2_NEEDLE_SHOT_COUNT 5	// 針を発射する回数
#define ATTACK2_NEEDLE_SHOT_DIR_COUNT 5	// 針を発射する方向の数
#define ATTACK2_NEEDLE_SHOT_ANGLE 10.0f	// 針を発射する角度
